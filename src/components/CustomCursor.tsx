...
const CustomCursor = () => {
  ...
  return (
    <>
      ...
      <div
        ref={ringRef}
        className="fixed top-0 left-0 pointer-events-none z-[9999] w-9 h-9 rounded-full border border-white/70 opacity-0"
        aria-hidden="true"
      ...
      <div
        ref={dotRef}
        className="fixed top-0 left-0 pointer-events-none z-[9999] w-[5px] h-[5px] rounded-full bg-white opacity-0"
        aria-hidden="true"
        style={{ willChange: "transform" }}
      />
    </>
